...
class BME280:
  ...
  def altitude(self):
    ...
    pressure = float(self.pressure.strip("hPa"))  # Convert to float
    temperature = float(self.temperature.strip("C"))
    self.sea_level_pressure = 1013.25
    # return 44330 * (1.0 - math.pow(pressure / self.sea_level_pressure, 0.1903))
    return (((self.sea_level_pressure / pressure) ** (1 / 5.257)) - 1) * ((temperature + 273.15) / 0.0065)
